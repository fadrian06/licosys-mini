            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                >
                    <div class="flex justify-between mb-4">
                        ...
                        <a href="{{ route('products.create') }}" class="bg-blue-500 px-4 py-2 rounded hover:bg-blue-600">
                            Crear Producto
                        </a>
                    </div>
                    ...
                    <div class="mb-4">
                        <dl>
                            <dt class="text-sm font-medium text-gray-700">Valor actual de la tasa BCV:</dt>
                            <dd class="text-sm text-gray-900" x-text="`${currentBcvTax ? currentBcvTax.toFixed(2) : 'No definido'} (${currentDate})`"></dd>
                        </dl>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <template x-for="product in filteredProducts" :key="product.id">
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap" x-text="product.unit_price"></td>
                                        <td
                                            class="px-6 py-4 whitespace-nowrap"
                                            x-text="(product.unit_price * (bcvTax || 0) * revenueFactor).toFixed(2)"></td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a :href="'/products/' + product.id + '/edit'" class="text-blue-600 hover:text-blue-900">Editar</a>
                                            |
